...
void main(List<String> arguments) {
  ...
  print("\n$nombre vas andando por la carretera y esta llega a su fin, tienes dos opciones:\n" +
        "\n1.) Ir a la derecha." +
        "\n2.) Ir a la izquierda." +
        "\n\nOpción: ");
  ...
  switch (opcion) {
    ...
    case 2:
      print("\n$nombre tras un paseo, te encuentras un puente. ¿Qué quieres hacer?:\n" +
            "\n1.) Cruzar el puente." +
